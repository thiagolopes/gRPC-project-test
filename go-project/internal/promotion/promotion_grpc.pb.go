...
type DiscountServiceClient interface {
	AvailableDiscounts(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Discounts, error)
}
...
func (c *discountServiceClient) AvailableDiscounts(ctx context.Context, in *Order, opts ...grpc.CallOption) (*Discounts, error) {
	out := new(Discounts)
	err := c.cc.Invoke(ctx, "/discount.DiscountService/AvailableDiscounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DiscountServiceServer interface {
	AvailableDiscounts(context.Context, *Order) (*Discounts, error)
...
func (UnimplementedDiscountServiceServer) AvailableDiscounts(context.Context, *Order) (*Discounts, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AvailableDiscounts not implemented")
}
...
func _DiscountService_AvailableDiscounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Order)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DiscountServiceServer).AvailableDiscounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/discount.DiscountService/AvailableDiscounts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DiscountServiceServer).AvailableDiscounts(ctx, req.(*Order))
	}
...
var DiscountService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AvailableDiscounts",
			Handler:    _DiscountService_AvailableDiscounts_Handler,
		},
	},
