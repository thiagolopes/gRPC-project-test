...
_USER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="date_birth",
            full_name="discount.User.date_birth",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_DISCOUNT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="percentage",
            full_name="discount.Discount.percentage",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="discount_name",
            full_name="discount.Discount.discount_name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_DISCOUNTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="discounts",
            full_name="discount.Discounts.discounts",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
Discounts = _reflection.GeneratedProtocolMessageType(
    "Discounts",
    (_message.Message,),
    {
